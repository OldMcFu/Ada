...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#568a50e0#;
   ...
   u00129 : constant Version_32 := 16#67eb6d5a#;
   pragma Export (C, u00129, "ada__text_ioB");
   u00130 : constant Version_32 := 16#3cf1122b#;
   ...
   u00139 : constant Version_32 := 16#c742315f#;
   pragma Export (C, u00139, "extended_socketB");
   u00140 : constant Version_32 := 16#7c690c3f#;
   pragma Export (C, u00140, "extended_socketS");
   u00141 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00141, "gnatS");
   u00142 : constant Version_32 := 16#1a69b526#;
   pragma Export (C, u00142, "gnat__os_libS");
   u00143 : constant Version_32 := 16#7689a348#;
   pragma Export (C, u00143, "gnat__socketsB");
   u00144 : constant Version_32 := 16#fad32b27#;
   pragma Export (C, u00144, "gnat__socketsS");
   u00145 : constant Version_32 := 16#9fc71810#;
   pragma Export (C, u00145, "gnat__sockets__linker_optionsS");
   u00146 : constant Version_32 := 16#ef8e19e8#;
   pragma Export (C, u00146, "gnat__sockets__pollB");
   u00147 : constant Version_32 := 16#5b438f3f#;
   pragma Export (C, u00147, "gnat__sockets__pollS");
   u00148 : constant Version_32 := 16#93b8b471#;
   pragma Export (C, u00148, "gnat__sockets__thinB");
   u00149 : constant Version_32 := 16#0d90d779#;
   pragma Export (C, u00149, "gnat__sockets__thinS");
   u00150 : constant Version_32 := 16#485b8267#;
   pragma Export (C, u00150, "gnat__task_lockS");
   u00151 : constant Version_32 := 16#7d808794#;
   pragma Export (C, u00151, "system__task_lockB");
   u00152 : constant Version_32 := 16#23e798d6#;
   pragma Export (C, u00152, "system__task_lockS");
   u00153 : constant Version_32 := 16#94835be8#;
   pragma Export (C, u00153, "gnat__sockets__thin_commonB");
   u00154 : constant Version_32 := 16#39108f2b#;
   pragma Export (C, u00154, "gnat__sockets__thin_commonS");
   u00155 : constant Version_32 := 16#e652c197#;
   pragma Export (C, u00155, "system__return_stackS");
   u00156 : constant Version_32 := 16#40f98252#;
   pragma Export (C, u00156, "interfaces__c__stringsB");
   u00157 : constant Version_32 := 16#a856e1a3#;
   pragma Export (C, u00157, "interfaces__c__stringsS");
   u00158 : constant Version_32 := 16#c7b9aba1#;
   pragma Export (C, u00158, "system__os_constantsS");
   u00159 : constant Version_32 := 16#fa09c8ad#;
   pragma Export (C, u00159, "system__arith_64B");
   u00160 : constant Version_32 := 16#b6ccbb3b#;
   pragma Export (C, u00160, "system__arith_64S");
   u00161 : constant Version_32 := 16#119c6c25#;
   pragma Export (C, u00161, "system__sparkS");
   u00162 : constant Version_32 := 16#812db2df#;
   pragma Export (C, u00162, "system__spark__cut_operationsB");
   u00163 : constant Version_32 := 16#46c019b4#;
   pragma Export (C, u00163, "system__spark__cut_operationsS");
   u00164 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00164, "system__communicationB");
   u00165 : constant Version_32 := 16#dfb0b3e3#;
   pragma Export (C, u00165, "system__communicationS");
   u00166 : constant Version_32 := 16#28888d98#;
   pragma Export (C, u00166, "system__finalization_mastersB");
   u00167 : constant Version_32 := 16#02e4eddb#;
   ...
   u00169 : constant Version_32 := 16#bf8c6aef#;
   pragma Export (C, u00169, "system__storage_poolsS");
   u00170 : constant Version_32 := 16#7c78c3c5#;
   pragma Export (C, u00170, "system__pool_globalB");
   u00171 : constant Version_32 := 16#91b367a5#;
   pragma Export (C, u00171, "system__pool_globalS");
   u00172 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00172, "system__memoryB");
   u00173 : constant Version_32 := 16#19e99d68#;
   pragma Export (C, u00173, "system__memoryS");
   u00174 : constant Version_32 := 16#b49a0e5d#;
   pragma Export (C, u00174, "system__storage_pools__subpoolsB");
   u00175 : constant Version_32 := 16#a2d8d50c#;
   pragma Export (C, u00175, "system__storage_pools__subpoolsS");
   u00176 : constant Version_32 := 16#b0df1928#;
   pragma Export (C, u00176, "system__storage_pools__subpools__finalizationB");
   u00177 : constant Version_32 := 16#562129f7#;
   pragma Export (C, u00177, "system__storage_pools__subpools__finalizationS");
   u00178 : constant Version_32 := 16#aeff9098#;
   pragma Export (C, u00178, "ada__strings__unboundedB");
   u00179 : constant Version_32 := 16#9427d056#;
   pragma Export (C, u00179, "ada__strings__unboundedS");
   u00180 : constant Version_32 := 16#9211d95c#;
   pragma Export (C, u00180, "ada__strings__searchB");
   u00181 : constant Version_32 := 16#501fe7a7#;
   pragma Export (C, u00181, "ada__strings__searchS");
   u00182 : constant Version_32 := 16#190570e0#;
   pragma Export (C, u00182, "system__compare_array_unsigned_8B");
   u00183 : constant Version_32 := 16#d28b31db#;
   pragma Export (C, u00183, "system__compare_array_unsigned_8S");
   u00184 : constant Version_32 := 16#74e358eb#;
   pragma Export (C, u00184, "system__address_operationsB");
   u00185 : constant Version_32 := 16#3c598318#;
   pragma Export (C, u00185, "system__address_operationsS");
   u00186 : constant Version_32 := 16#a8ed4e2b#;
   pragma Export (C, u00186, "system__atomic_countersB");
   u00187 : constant Version_32 := 16#9e75407b#;
   pragma Export (C, u00187, "system__atomic_countersS");
   u00188 : constant Version_32 := 16#d50f3cfb#;
   pragma Export (C, u00188, "system__stream_attributesB");
   u00189 : constant Version_32 := 16#5e0388d4#;
   pragma Export (C, u00189, "system__stream_attributesS");
   u00190 : constant Version_32 := 16#3aecdcda#;
   pragma Export (C, u00190, "system__stream_attributes__xdrB");
   u00191 : constant Version_32 := 16#42985e70#;
   pragma Export (C, u00191, "system__stream_attributes__xdrS");
   u00192 : constant Version_32 := 16#815f70d4#;
   pragma Export (C, u00192, "system__fat_fltS");
   u00193 : constant Version_32 := 16#a76d79d9#;
   pragma Export (C, u00193, "system__fat_lfltS");
   u00194 : constant Version_32 := 16#ddbdd733#;
   pragma Export (C, u00194, "system__fat_llfS");
   u00195 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00195, "system__concat_4B");
   u00196 : constant Version_32 := 16#7195f086#;
   pragma Export (C, u00196, "system__concat_4S");
   u00197 : constant Version_32 := 16#602bc0ef#;
   pragma Export (C, u00197, "system__img_lliS");
   u00198 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00198, "system__wid_lluS");
