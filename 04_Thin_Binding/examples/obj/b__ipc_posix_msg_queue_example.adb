pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__ipc_posix_msg_queue_example.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__ipc_posix_msg_queue_example.adb");
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "linux__ipc_posix_msg_queue__finalize_spec");
      begin
         F1;
      end;
      E153 := E153 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ipc_posix_msg_queue_example");
...
--  BEGIN Object file/option list
   ...
   --   /workspaces/redhat/Ada/04_Thin_Binding/examples/obj/ipc_posix_msg_queue_example.o
